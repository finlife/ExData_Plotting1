...
plot(x=data$dt, y = as.numeric(data$Global_active_power)/1000, xlab="", ylab = "Global Active Power", type ="l")

plot(x=data$dt, y = as.numeric(data$Voltage), xlab = "datetime", ylab = "Voltage", type ="l" )
...
plot(x=data$dt, y = as.numeric(data$Global_reactive_power)/100, xlab = "datetime", ylab = "Global_reactive_power", type ="l" )
